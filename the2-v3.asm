...
timer_interrupt:
    ...
    clrf	rd3_state
    bsf		rd3_state, 0 ; not pressed any longer (in case a long press)
    clrf	rd1_state
    bsf		rd1_state, 0 ; not pressed any longer (in case a long press)
    clrf	rd2_state
    bsf		rd2_state, 0 ; not pressed any longer (in case a long press)
    clrf	key_hit_counter
